            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="scoring.php">Scoring</a>
                        <a class="collapse-item active" href="lda.php">LDA Topic</a>
                    </div>
                </div>
            </li>
                ...
                <div class="col-lg-12 mb-4">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lda Topic Modelling</h6>
                        </div>
                        <div class="card-body">
                            
                        <div class="col-md-12 mb-4 text-center">
                                <div class="border p-3">
                                    <img src="../assets/img/wordcloud_topic.png" alt="top-5 score Image" class="img-fluid">
                                </div>
                            </div> 
